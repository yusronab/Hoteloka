...
if(isset($_POST['submit'])){
    ...
    $statement = oci_parse($connection,"UPDATE TB_USER SET NAMA='$nama', USERNAME='$username', EMAIL='$email', UPDATED_AT=TO_DATE('$updated_at','yyyy-mm-dd hh24:mi:ss'), GAMBAR='$upload' WHERE ID_USER='$id_user'");
    $statement2 = oci_parse($connection,"UPDATE TB_USER SET NAMA='$nama', USERNAME='$username', EMAIL='$email', UPDATED_AT=TO_DATE('$updated_at','yyyy-mm-dd hh24:mi:ss') WHERE ID_USER='$id_user'");
